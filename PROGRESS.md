...
| 43 | Growth Hormone Deficiency and Hypothyroidism | 199 | 5 | ✅ DONE — 146 Q, 6 units |
| 44 | Adrenal Disorders in Children | 204 | 5 | ✅ DONE — 162 Q, 8 units |
...
| 51 | Congenital Haemolytic Anaemia | 241 | 7 | ✅ DONE — 266 Q, 16 units |
| 52 | Bleeding Disorders | 248 | 5 | ✅ DONE — 176 Q, 10 units |
| 53 | Paediatric Resuscitation | 253 | 3 | ✅ DONE — 120 Q, 6 units |
| 54 | Shock | 256 | 4 | ✅ DONE — 154 Q, 7 units |
...
- [x] **ENDOCRINE BATCH — CH43–CH45 (p199–212): DONE** — 300 dpi grayscale renders of all 14 pages, OCR + glyph forensics (scans without text layer), source-page pass, question authoring, data validation, app rebuild and browser-flow validation:
  - **CH43 Growth Hormone Deficiency and Hypothyroidism** — 146 Q, 6 units: GHD types/Laron, GHD clinical features, GHD investigations & treatment, congenital hypothyroidism etiology/features and investigations/treatment, endemic cretinism + acquired hypothyroidism. 102 MCQ · 15 fill-ups · 9 T/F · 6 match · 8 clinical cases · 6 odd-one-out.
...
- [x] **CH51 Congenital Haemolytic Anaemia (p241–247): DONE** — 300+ dpi page renders of all 7 pages, full visual read (every line, flow-chart, table, figure label and diagram annotation) with zoom-crops on the membrane-protein diagram, the HMP-shunt flow chart and the iron-overload MRI branch; question authoring, key rotation, data validation, app rebuild and complete browser-flow simulation:
  - **266 questions · 16 units**, strict book order p241 → p247:
  - **U404 Classification** (three branches: defects of red cell membrane → hereditary spherocytosis; disorders of red cell metabolism → G6PD deficiency; haemoglobinopathies/defect in globin chain → sickle cell anaemia and thalassaemia)
  - **U405 HS inheritance, pathogenesis & membrane proteins** (autosomal dominant; cytoskeletal protein defect → spherical RBC → ↓ deformability → splenic microcirculation entrapment → haemolysis → splenomegaly; diagram labels ConA, Band 3, Glycophorin A, lipid bilayer, spectrin, ankyrin, actin, Band 4.1 — Band 4.1 m/c defect, spectrin 2nd m/c and most severe)
  - **U406 HS clinical features** (variable onset, 50% neonatal jaundice, splenomegaly, family history +, pigment gallstones from ↑ bilirubin, aplastic crisis; parvovirus B19 → marrow dysfunction → pancytopenia)
  - **U407 HS investigations** (lack of central pallor; surface-area loss → cellular dehydration → ↑ intracellular Hb → hyperchromia; ↑ MCHC characteristic; ↑ osmotic fragility via ↑ Na+ permeability → swelling/lysis at lower hypotonic saline; incubated OF at 37 °C × 24 h improves sensitivity; OF also seen in other haemolytic disorders; confirmatory — flow cytometry ↓ EMA binding, molecular testing)
  - **U408 HS management & splenectomy consequences** (lifelong folic acid for megaloblastic erythropoiesis, given to all chronic haemolytic anaemias; splenectomy best modality → ↓ lysis → ↑ RBC lifespan → ↓ anaemia; laparoscopic partial splenectomy preferred; concomitant cholecystectomy; absence of splenic macrophages → encapsulated bacteria especially < 6 yr — pneumococcus, Hib, meningococcus; precautions — surgery > 6 yr, immunization, penicillin 2 years post-sx)
  - **U409 G6PD epidemiology & pathophysiology** (m/c RBC enzyme deficiency, X-linked recessive, Africans/Mediterraneans/Asians; HMP shunt glucose-6-phosphate → NADP→NADPH → 6-phosphoglycerate → reduced glutathione protects from oxidative stress; block → ↓ reduced glutathione → haemolysis)
  - **U410 G6PD clinical features & precipitants** (early neonatal jaundice vs late episodic haemolysis; fever, fava beans, drugs starting 2–3 days after exposure and self-limiting — primaquine, nitrofurantoin, sulfonamides, nalidixic acid, phenazopyridine)
  - **U411 G6PD investigations & management** (Hb → oxidative stress → methaemoglobin → condensation → Heinz bodies → engulfed by splenic macrophages → bite cells; RBC enzyme assay confirmatory; supportive management, avoid implicated drugs)
  - **U412 Sickle cell genetics & pathogenesis** (autosomal recessive, tribal Madhya Pradesh & Maharashtra; β-globin gene mutation, glutamate → valine at 6th position, HbS vs normal HbA; hypoxia/dehydration/fever/metabolic acidosis → sickling → fragile RBCs → haemolysis; blockage → ischaemia → infarction)
  - **U413 Sickle cell clinical features & crises** (manifests > 6 months as HbF is protective; icterus, pallor, vaso-occlusive painful crisis characteristic, dactylitis in infancy, acute chest syndrome with new infiltrates, stroke; repeated infarcts → autosplenectomy by 6 yr → functional hyposplenism → encapsulated infection; venous blockade → acute pooling → ≥ 2% Hb reduction → pallor/shock; aplastic crisis = parvovirus B19 pancytopenia)
  - **U414 Sickle cell investigations & trait** (sickled RBCs; sickling test with 2% sodium metabisulphite; Hb electrophoresis initial best diagnostic; HPLC gold standard detecting and quantifying HbS; trait HbA + HbS → less severe)
  - **U415 Sickle cell management & preventive care** (hydration, analgesia; PRBC for aplastic/sequestration crisis to ↑ O₂ carrying capacity; exchange transfusion for acute chest syndrome and stroke, goal HbS < 30%; HSCT curative; crizanlizumab anti-P-selectin, voxelotor ↓ HbS polymerization; penicillin infancy → 5 yr, immunization, hydroxyurea ↑ HbF started > 9 months)
  - **U416 β-thalassaemia genotype table** (autosomal recessive; key β / β+ ↓ production / β⁰ no production; β/β normal, β/β+ trait asymptomatic, β+/β+ or β+/β⁰ intermedia with β+/β⁰ > β+/β+, β⁰/β⁰ major/Cooley's anaemia most severe needing transfusion every 3–4 weeks)
  - **U417 β-thalassaemia pathophysiology & features** (absent β-chain → α-chain accumulation → cell instability → early destruction → ineffective erythropoiesis → severe transfusion-dependent anaemia + extramedullary haematopoiesis; hepatosplenomegaly, skull expansion; thalassemic facies — frontal bossing, depressed nasal bridge, maxillary prominence, dental malocclusion; hair-on-end skull from prominent vertical trabeculae; α : β produced 1 : 1)
  - **U418 β-thalassaemia investigations & management** (nucleated RBCs, microcytic hypochromic with central pallor > 1/3; Hb electrophoresis initial, HPLC gold standard; transfusion every 3–4 weeks with leukocyte-depleted/irradiated products, pre-transfusion target Hb 9–10 g/dL to ↓ deformities and promote growth; HSCT curative)
  - **U419 Iron overload & chelation** (after > 1 yr of transfusion; cardiotoxicity the major cause of morbidity/mortality; liver, spleen, heart damaged; high transferrin saturation ↓ lactoferrin bacteriostasis → infections m/c Yersinia enterocolitica; ferritin > 1000 pg/L, R2/R2* liver MRI best and T2-weighted cardiac MRI; deferasirox oral preferred/mild GI, deferoxamine s.c. ototoxicity + retinal toxicity, deferiprone oral neutropenia + cartilage damage)
  - Format mix **133 MCQ · 44 fill-ups · 32 T/F (16 T / 16 F) · 19 match · 16 odd-one-out · 22 clinical cases**; answer-key rotation → non-TF index distribution **61/59/56/58**; 0 length-giveaway options; distractors drawn from neighbouring diseases in the same chapter (spherocytosis vs G6PD vs sickle vs thalassaemia), so no option can be eliminated on general grounds
  - **Bank-wide match integrity re-verified:** all **275** match questions parse `Correct pairs:` against the displayed column-B order and point at the true permutation — **0 mismatches** (also normalised the one legacy exp wording in CH30)
  - Build: `validate.py` **5995 Q / 419 U / 51 files / 0 errors / 0 warnings**; `node --check` on the extracted app script: pass; `validate.js` extended with a **full CH51 playthrough (all 266 Q across 16 units)** asserting guide rendering, book order, exactly one correct rendered option, match two-column rendering, fill-blank rendering and case-vignette rendering → **ALL CHECKS PASSED (918 assertions)**
- [x] **FINAL BATCH — CH52–CH54 (p248–259): DONE** — 300 dpi page renders of all 12 pages, full visual read of every line, table, flow-chart, diagram label and ECG strip with zoom-crops on the hemostasis diagram, hemophilia dose constants (K 0.5/1.4), CPR energy/drug numbers, ET-tube formulas, reversible-cause list, distributive diagram labels and the shock-algorithm dosage box; question authoring with same-section distractors, key rotation, data validation, app rebuild and complete browser-flow simulation:
  - **CH52 Bleeding Disorders (p248–252)** — **176 Q, 10 units** (U420–U429), strict book order: hemostasis triad + diagram labels (vWF/FVIII, X→Xa, GpIIb/IIIa, GpIb, fibrinogen at the endothelial defect); vascular (HSP, scurvy/Vit C, HHT/Osler-Weber-Rendu) vs non-vascular (thrombocytopenia, factor defects) etiology; platelet-vs-coagulation 5-row table; ITP molecular mimicry (viral 1–7 yr → anti–GP IIb/IIIa → spleen → Fc macrophages → lysis → ↑ marrow megakaryocytes); ITP types (acute < 3 m/c 60–75% recovering, persistent 3–12, chronic > 12) and acute features (1–7 yr, viral 1–4 wks → petechiae >> epistaxis/oozing, well child, rare fatal CNS bleeds, no nodes/spleen → else leukemia); ITP Ix (young large platelets, ↑ megakaryocytes) and Mx (supportive, symptom-based, IVIG best, prednisolone, platelets only if life-threatening) + other thrombocytopenia causes (aplastic, infiltration, SLE, parvovirus/EBV/varicella/rubella/mumps, heparin/valproate/phenytoin/NSAIDs/penicillins-cephalosporins); hemophilia A/B/C factors + XLR vs AR, hemarthrosis hallmark (knee > elbow/ankle), target joint → fibrosis → restricted movement (m/c morbidity); severity bands (5–40/1–4/< 1) with adolescent/mild, trauma/moderate and neonatal clues (IM hematoma, circumcision, large cephalhematoma) + ↑ APTT intrinsic and best-test factor assay; factor dosing (40% joint, 100% CNS, K 0.5 A / 1.4 B), FFP, cryo (VIII + fibrinogen, A only), inhibitor complication → bypass agents (rFVIIa, APCs/FEIBA, emicizumab anti-VIII A-only); VWD (m/c worldwide, mostly AD, VWF ↑ VIII half-life + platelet–collagen bridge), types (1: 80% quantitative partial; 2: qualitative dysproteinemia; 3: complete, resembles hemophilia A) and type-wise Ix (↑ APTT, antigen 1&3, multimer + ristocetin 2) and Mx (desmopressin type 1, concentrates type 2&3). Format mix **68 MCQ · 45 fill · 21 T/F (10 T / 11 F) · 11 match · 18 case · 13 odd**; rotated keys 39/41/39/36.
  - **CH53 Paediatric Resuscitation (p253–255)** — **120 Q, 6 units** (U430–U435): arrest causes (respiratory > cardiac; respiratory failure, terminal shock); CPR flowchart (pulseless → CPR + reassess q2 cycles + AED; pulse-only → PPV 20–30/min, assess q2 min, CPR if pulseless or HR < 60 + poor perfusion; reversible causes both sides; 15:2 / 30:2 outside hospital; intubated 100–120 + 20–30 in hospital); shockable (2 J/kg → CPR → upto 10 J/kg → refractory lidocaine/amiodarone) vs non-shockable (epi 0.1 ml/kg 1:10,000 q3–5 min + 2-min CPR); assessment (scene safety, supine hard surface, immobilise if fracture/RTA, body-movement responsiveness, brachial < 1 yr else carotid/femoral, simultaneous < 10 s) and circulation (lower 1/3 sternum, 100–120/min, 1/3 AP depth, full recoil, push hard/fast); airway (head tilt–chin lift, jaw thrust), bag-mask vs ETT (in-hospital/prolonged), cuffed (Age+4)/4 tube, cuff < 20–25 cmH2O, depth 3 × Age, no routine cricoid, 20–30 breaths/min; access (IV/femoral preferred, IO proximal tibia > distal femur below tuberosity), AED (rhythm display, asynchronous depolarisation), wide-QRS shockable (V-fib irregular, PVT regular) vs asystole/PEA; reversible 6H (hypovolemia, hypothermia, hypoglycemia, H+ acidosis, hypo/hyperkalemia) and 4T (thromboembolism pulmonary/coronary, toxin, pericardial tamponade, tension pneumothorax). Format mix **44 MCQ · 33 fill · 17 T/F (7 T / 10 F) · 6 match · 14 case · 6 odd**; rotated keys 23/27/28/25.
  - **CH54 Shock (p256–259)** — **154 Q, 7 units** (U436–U442): definition (circulatory dysfunction → ↓ O2 delivery, perfusion insufficient for demands); types (hypovolemic m/c hemorrhage/dehydration; cardiogenic CHD/myocarditis/cardiomyopathy; distributive anaphylactic/neurogenic; septic = all 3); compensated (brain/heart/kidney held by sympathetic → ↑ SVR → ↑ contractility → skin diverted) vs decompensated (multiorgan) with CRT technique (thumb blanch, ≤ 2 normal, > 3 shock) and the 6-row comp-vs-decomp table (mental, HR, CRT > 3 vs > 5, urine, BP, RR); hypovolemic clues (dry mouth, ↓ tears, sunken eyes, oliguria, ↑ creatinine/urea, ↓ CVP, ↓ preload diagram) vs cardiogenic (impaired contractility → venous pooling, ↑ CVP/JVP, S3, hepatomegaly, murmurs, pericarditis rub, ventricular-failure diagram); distributive warm shock (warm + bounding + flash < 1 s, ↓ SVR vasodilatation) and septic cold-vs-warm table; algorithm (quick recognition, high-flow O2, IV → IO at 60 s, check hypoglycemia/sepsis, 10–20 then 20 ml/kg upto 60 ml/kg 1st hr, refractory at 60 min; cold = vasodilation epi/dopamine 5–9 vs warm = vasoconstriction norepi/dopamine ≥ 10, start 0.05 → 3; catecholamine-resistant → steroids if adrenal doubt + monitoring + Hb > 10); branch therapy (cold + normal BP vasodilators; cold + ↓ BP max epi + norepi for diastolic → milrinone/levosimendan; warm + ↓ BP volume + vasopressin → milrinone/levo if CO ↓; reversible effusion/pneumothorax → ECMO outside-body oxygenation); IO sites, rules of 60, crystalloids (NS/RL isotonic only) >> colloids, sepsis cover (3rd-gen cephalosporin + vancomycin), pressors/inotropes (PDE-III milrinone, Ca-sensitizer levosimendan)/vasodilators and endpoints (HR/BP, urine > 1, CRT < 2, mentation). Format mix **60 MCQ · 44 fill · 18 T/F (10 T / 8 F) · 7 match · 16 case · 9 odd**; rotated keys 30/36/33/37.
  - **Quality gates:** 450 source-grounded new questions, every line/table/flowchart/diagram/ECG covered in strict book order; all six formats in every chapter; same-section non-obvious distractors with 0 length-giveaway options (68 flagged drafts rewritten); deranged match columns with near-miss swap distractors; bank-wide match integrity re-verified — all **299** match questions resolve `Correct pairs:` against the displayed column-B order — **0 mismatches**. `validate.py`: **6445 Q / 442 U / 54 files / 0 errors / 0 warnings**. `node --check`: pass. `validate.js`: full CH52–CH54 unit-by-unit playthroughs (guides, book order, exactly-one-correct, match/fill/case UI, all-6-formats) — **ALL CHECKS PASSED (1035 assertions)**.
- [x] App rebuilt: **6445 questions live (54 chapters, 442 units)** — home hero shows "54 of 54" — **THE BOOK IS COMPLETE** 🎉
